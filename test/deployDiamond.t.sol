...
contract DiamondDeployer is Test, IDiamondCut {
    ...
    ERC721Facet erc721F;
    NFTMarketPlaceFacet nftMarketF;
    ...
    function setUp() public {
        ...
        nftMarketF = new NFTMarketPlaceFacet();
        ...
        cut[3] = (
            FacetCut({
                facetAddress: address(nftMarketF),
                action: FacetCutAction.Add,
                functionSelectors: generateSelectors("NFTMarketPlaceFacet")
            })
        );
    ...
    function testNameAndSymbol() public {
        ERC721Facet e = ERC721Facet(address(diamond));
        assertEq(e.name(), "ONChain");
        assertEq(e.symbol(), "ONC");
    }
    ...
    function testListNft() public {
        ERC721Facet e = ERC721Facet(address(diamond));
        NFTMarketPlaceFacet n = NFTMarketPlaceFacet(address(diamond));
        switchSigner(A);
        e.mint{value: 0.01 ether}();
